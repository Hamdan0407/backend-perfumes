# Test chatbot conversation with product lookup
$conversationId = "test-$(Get-Random)"
Write-Host "Testing Chatbot with conversation ID: $conversationId"
Write-Host ""
...
Write-Host "BOT: $($data3.message)"
Write-Host ""

# Test 4: Budget (should trigger recommendations)
Write-Host "=== TEST 4: Budget and Recommendations ===" -ForegroundColor Cyan
