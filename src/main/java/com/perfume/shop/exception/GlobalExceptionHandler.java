...
/**
 * Global exception handler for consistent error responses across all API
 * endpoints.
 * 
 * Handles:
...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleValidationExceptions(
                ...
                log.warn("[{}] Validation failed for request: {}", requestId, getRequestPath(request));
                ...
                ex.getBindingResult().getAllErrors().forEach((error) -> {
                        ...
                        log.debug("[{}] Field validation error: {} = {}", requestId, fieldName, errorMessage);
                });
        ...
        public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
                ...
                String requestId = generateRequestId();
                log.error("[{}] Database constraint violation", requestId, ex);
        ...
        private void writeStackTraceToFile(Exception ex) {
                try (java.io.PrintWriter pw = new java.io.PrintWriter(new java.io.FileWriter("stacktrace.log", true))) {
                        pw.println("========== " + java.time.LocalDateTime.now() + " ==========");
                        ex.printStackTrace(pw);
                        pw.println("==================================================");
                } catch (java.io.IOException e) {
                        log.error("Failed to write stack trace to file", e);
                }
        }
